...
export const STAGES = [
  ...
  },
  {
    ...
    terrain: 'prehistoric',
    items: [
      { id: 'trex', emoji: '🦖', name: '티라노사우루스', desc: '팔이 너무 짧아서 박수를 못 쳤대요! 이빨은 바나나만 해요 🦖', size: 38 },
      { id: 'tricera', emoji: '🦕', name: '트리케라톱스', desc: '뿔이 3개! 이름 뜻이 "세 뿔 얼굴"이에요 🦕', size: 38 },
      { id: 'stego', emoji: '🦕', name: '스테고사우루스', desc: '등에 판 모양 뼈가 있어요! 체온 조절용이래요 🌡️', size: 38 },
      { id: 'brachio', emoji: '🦕', name: '브라키오사우루스', desc: '목이 엄청 길어요! 키가 아파트 4층 높이! 🏢', size: 38 },
      { id: 'ptero', emoji: '🦅', name: '프테라노돈', desc: '하늘을 나는 파충류! 공룡은 아니에요! 날개폭 7m! ✈️', size: 38 },
      { id: 'veloci', emoji: '🦖', name: '벨로키랍토르', desc: '아주 빠르고 똑똒했어요! 깃털이 있었대요 🪶', size: 38 },
      { id: 'ankylo', emoji: '🦕', name: '안킬로사우루스', desc: '온몸이 갑옷! 꼬리에 거대한 뼈 뭉치가 있어요 🛡️', size: 38 },
      { id: 'spino', emoji: '🦖', name: '스피노사우루스', desc: '등에 큰 돛이 있어요! 물고기를 잡아먹었어요 🐟', size: 38 },
      { id: 'parasauro', emoji: '🦕', name: '파라사우롤로푸스', desc: '머리에 긴 볏이 있어요! 나팔처럼 소리를 냈어요 🎺', size: 38 },
      { id: 'diplo', emoji: '🦕', name: '디플로도쿠스', desc: '꼬리가 채찍처럼 길어요! 길이 27m! 🏃', size: 38 },
      { id: 'compy', emoji: '🦖', name: '콤프소그나투스', desc: '닭만 한 작은 공룡! 아주 빨라요! 🐔', size: 38 },
      { id: 'pachy', emoji: '🦕', name: '파키케팔로사우루스', desc: '머리뼈가 25cm나 두꺼워요! 박치기왕! 💥', size: 38 },
    ],
  },
  {
    id: 'animals',
    ...
    items: [
      ...
      { id: 'seahorse', emoji: '🐴', name: '해마', desc: '아빠가 아기를 낳아요! 꼬리로 해초를 잡아요 🌊', size: 34 },
